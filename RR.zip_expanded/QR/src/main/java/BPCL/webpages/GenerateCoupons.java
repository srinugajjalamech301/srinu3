...
public class GenerateCoupons {
	...
	public GenerateCoupons(WebDriver driver) {
	...
	By generateButton = By.cssSelector("button[title='Generate Coupons']");
	
	
	By generateCoupons = By.cssSelector("#generatecoupons");
